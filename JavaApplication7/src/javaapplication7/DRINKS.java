...
private double total=0.0;
    ...
    private void initComponents() {
        ...
        jLabel20.setText("THEY ARE SOLD IN BULK (6BOTTLES OR CANS) PER ORDER");
        ...
        jLabel42.setIcon(new javax.swing.ImageIcon(getClass().getResource("/DRINKS/11.jpg"))); // NOI18N
        ...
        jLabel3.setText("LAEGER");

        jLabel23.setText("R170.00");

        jLabel31.setText("Amount");

        jLabel43.setIcon(new javax.swing.ImageIcon(getClass().getResource("/DRINKS/12.2.jpg"))); // NOI18N
        ...
        jLabel12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/DRINKS/17.jpg"))); // NOI18N
        ...
        jLabel9.setText("WHINE");

        jLabel26.setText("R180.00");

        jLabel34.setText("Amount");

        jLabel49.setIcon(new javax.swing.ImageIcon(getClass().getResource("/DRINKS/15.jpg"))); // NOI18N
        ...
        jPanel16Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel16Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jPanel24, javax.swing.GroupLayout.PREFERRED_SIZE, 95, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        jLabel8.setText("LIPTON");

        jLabel27.setText("R170.00");

        jLabel35.setText("Amount");

        jLabel48.setIcon(new javax.swing.ImageIcon(getClass().getResource("/DRINKS/16.jpg"))); // NOI18N
        ...
        jPanel17Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel17Layout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(jPanel25, javax.swing.GroupLayout.PREFERRED_SIZE, 158, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(104, 104, 104))
        );
        ...
        jPanel9Layout.setVerticalGroup(
            ...
            .addGroup(jPanel9Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jPanel17, javax.swing.GroupLayout.PREFERRED_SIZE, 178, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        jLabel47.setIcon(new javax.swing.ImageIcon(getClass().getResource("/DRINKS/17.2.jpg"))); // NOI18N
        ...
        jPanel18Layout.setVerticalGroup(
            ...
            .addGroup(jPanel18Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jPanel26, javax.swing.GroupLayout.PREFERRED_SIZE, 156, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        jLabel13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/DRINKS/13.2.jpg"))); // NOI18N

        jLabel5.setText("ORANGE JUICE");
        ...
        jLabel14.setIcon(new javax.swing.ImageIcon(getClass().getResource("/DRINKS/14.jpg"))); // NOI18N

        jLabel6.setText("COLD DRINK");
    ...
    private void jCheckBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox1ActionPerformed
        ...
        if(qtyIsZero(qty)&&jCheckBox1.isSelected()){
           ...
           double price8=qty*130.0;
           total+=price8;
           jTextArea1.setText(jTextArea1.getText()+x+". "+jLabel2.getText()+"\t\t\t\t\t"+price8+"\n");
        }else{
    ...
    private void jCheckBox2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox2ActionPerformed
        // TODO add your handling code here:
        int qty8=Integer.parseInt(jSpinner2.getValue().toString());
        if(qtyIsZero(qty8)&&jCheckBox2.isSelected()){
           x++;
           if(x==0){
               Gusto();
           }
           double price8=qty8*170.0;
           total+=price8;
           jTextArea1.setText(jTextArea1.getText()+x+". "+jLabel3.getText()+"\t\t\t\t"+price8+"\n");
        }else{
    ...
    private void jCheckBox3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox3ActionPerformed
        // TODO add your handling code here:
        int qty8=Integer.parseInt(jSpinner3.getValue().toString());
        if(qtyIsZero(qty8)&&jCheckBox3.isSelected()){
           x++;
           if(x==0){
               Gusto();
           }
           double price8=qty8*165.0;
           total+=price8;
           jTextArea1.setText(jTextArea1.getText()+x+". "+jLabel5.getText()+"\t\t\t\t"+price8+"\n");
        }else{
    ...
    private void jCheckBox4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox4ActionPerformed
        // TODO add your handling code here:
        int qty8=Integer.parseInt(jSpinner4.getValue().toString());
        if(qtyIsZero(qty8)&&jCheckBox4.isSelected()){
           x++;
           if(x==0){
               Gusto();
           }
           double price8=qty8*130.0;
           total+=price8;
           jTextArea1.setText(jTextArea1.getText()+x+". "+jLabel6.getText()+"\t\t\t\t"+price8+"\n");
        }else{
    ...
    private void jCheckBox5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox5ActionPerformed
        // TODO add your handling code here:
        int qty8=Integer.parseInt(jSpinner5.getValue().toString());
        if(qtyIsZero(qty8)&&jCheckBox5.isSelected()){
           x++;
           if(x==0){
               Gusto();
           }
    ...
    private void jCheckBox6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox6ActionPerformed
        // TODO add your handling code here:
        int qty8=Integer.parseInt(jSpinner6.getValue().toString());
        if(qtyIsZero(qty8)&&jCheckBox6.isSelected()){
           x++;
           if(x==0){
               Gusto();
           }
           double price8=qty8*170.0;
           total+=price8;
           jTextArea1.setText(jTextArea1.getText()+x+". "+jLabel8.getText()+"\t\t\t\t"+price8+"\n");
        }else{
    ...
    private void jCheckBox7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox7ActionPerformed
        ...
        if(qtyIsZero(qty8)&&jCheckBox7.isSelected()){
           ...
           double price8=qty8*175.0;
           total+=price8;
           jTextArea1.setText(jTextArea1.getText()+x+". "+jLabel7.getText()+"\t\t\t\t"+price8+"\n");
        }else{
    ...
    private void jCheckBox8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox8ActionPerformed
        ...
        if(qtyIsZero(qty8)&&jCheckBox8.isSelected()){
           ...
           double price8=qty8*120.0;
           total+=price8;
           jTextArea1.setText(jTextArea1.getText()+x+". "+jLabel4.getText()+"\t\t\t\t"+price8+"\n");
        }else{
 ...
 public void Gusto(){
        ...
        int qty4 = Integer.parseInt(jSpinner4.getValue().toString());
        int qty5 = Integer.parseInt(jSpinner5.getValue().toString());
        int qty6 = Integer.parseInt(jSpinner6.getValue().toString());
        int qty7 = Integer.parseInt(jSpinner7.getValue().toString());
        int qty8 = Integer.parseInt(jSpinner8.getValue().toString());
        ...
        double price7 = qty7 * 60.00;
        double price8 = qty8 * 50.00;
